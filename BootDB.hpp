/*
This is a bootstraped database api for the protocal.
In the future it my be replaced with a sqlite3 or whatever. I dont have time to learn a new API.
Or another will be build on top of it. Maybe use vector of BOOTDB_BLOCK_SIZE to create a whole filesystem.
...
namespace BootDB
{
    ...
    enum RecordType // All records have a size of BOOTDB_BLOCK_SIZE variable.
    {
        MasterPrivateKey = 0, // Block 0
        MasterPublicKey,      // Block 1
        IsVerifiedNode,
        NodeInfo,
        HostInfo,
        KeyStore,
        ...
        R5,
        R6
    }; // Undefined blocks will still be valid.
    class LocalDatabase
    {
    public:
